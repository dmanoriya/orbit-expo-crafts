	...
	public static function get_default_configs() {
		return array(
			'suppliers_vendors' => array(
				...
				'enquiry_number'  => '01',
				'visual'          => array(
					'image_url' => '/woodcraft-factory.webp',
					'tag'       => 'MADE IN JODHPUR · MADE FOR THE WORLD',
					'headline'  => 'From raw timber & fine metals to finished luxury pieces, we build enduring supply partnerships.',
				),
				'form'            => array(
					'eyebrow'            => 'SUPPLIERS & VENDORS ENQUIRY',
					'title'              => 'Tell us about your products & supply capabilities.',
